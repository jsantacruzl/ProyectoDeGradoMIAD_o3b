  SELECT *
  INTO [dbo].[Test2_Secop2_Completo]
  FROM [dbo].[Test_Secop2_Completo]
	...
	update [dbo].[Test2_Secop2_Completo] set [Descripción del Procedimiento] = NULL WHERE [Descripción del Procedimiento] = 'nan';
	...
	update [dbo].[Test2_Secop2_Completo] set [Fecha de Publicacion (Fase Planeacion Precalificacion)] = NULL WHERE [Fecha de Publicacion (Fase Planeacion Precalificacion)] = 'nan';
	update [dbo].[Test2_Secop2_Completo] set [Fecha de Publicacion (Fase Seleccion Precalificacion)] = NULL WHERE [Fecha de Publicacion (Fase Seleccion Precalificacion)] = 'nan';
	...
	update [dbo].[Test2_Secop2_Completo] set [Categorias Adicionales] = NULL WHERE [Categorias Adicionales] = 'nan';
...
SELECT COUNT(*)
FROM [dbo].[Test2_Secop2_Completo]
...
SELECT [Entidad]
  ...
  INTO [dbo].[Prod_Secop2_Completo]
  FROM [dbo].[Test2_Secop2_Completo]


  SELECT [ID del Portafolio], [CodigoProveedor], COUNT(*) AS Cantidad
  FROM [dbo].[Prod_Secop2_Completo]
  GROUP BY [ID del Portafolio], [CodigoProveedor]
  ORDER BY Cantidad DESC

  SELECT count(*)
  FROM [dbo].[Prod_Secop2_Completo]
  WHERE [ID del Portafolio] LIKE 'CO1.BDOS.966003'
  AND [CodigoProveedor] LIKE '708267216'

  SELECT *
  FROM [dbo].[Prod_Secop2_ContratosElectronicos] 
  WHERE [Proceso de Compra] = 'CO1.BDOS.966003'
  AND [Codigo Proveedor] = '708267216'